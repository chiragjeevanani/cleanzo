...
import { ChevronRight, Car, Sun, Moon, LogOut, HelpCircle, Shield, Bell, MapPin, FileText, Loader2, Pencil, X, Check, CreditCard, ArrowLeft, Download, Clock, Trash2, AlertTriangle } from 'lucide-react'
    ...
    <div style={{ padding: '0 20px' }}>
      ...
      <button
        ...
        style={{
          ...
          marginBottom: FEATURES.ACCOUNT_DELETION ? 12 : 100,
        ...
        <div className="modal-overlay" onClick={() => !isDeleting && setShowDeleteModal(false)}>
          <div className="modal-content" style={{ padding: 24, borderRadius: 24, maxWidth: 400 }} onClick={e => e.stopPropagation()}>
            ...
            <p className="text-body-sm text-secondary" style={{ marginBottom: 20, lineHeight: 1.5 }}>
              This will <strong style={{ color: 'var(--text-primary)' }}>deactivate your account</strong> and sign you out immediately. To use Cleanzo again you'll need to contact support to restore your account.
            </p>
