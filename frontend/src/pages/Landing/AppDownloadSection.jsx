        ...
        <div className="app-content reveal">
          <div className="app-text">
            ...
            <div className="app-badges">
              <Link to="/" className="app-badge glass">
          ...
          <div className="app-phone-wrap">
            <div className="app-phone glass">
              <div className="app-phone-notch" />
              <div className="app-phone-screen">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px' }}>
                  <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 18 }}>Cleanzo</span>
                ...
                <div style={{ padding: '0 20px' }}>
                  <div className="glass" style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: 20 }}>Premium Detail</span>
                    <div className="progress-track"><div className="progress-fill" style={{ width: '65%' }} /></div>
                    <span className="text-body-sm text-secondary">Day 19 of 30</span>
                  </div>
                </div>
                <div style={{ padding: '16px 20px', display: 'flex', gap: 8 }}>
                  <div className="glass" style={{ flex: 1, padding: '14px 12px', textAlign: 'center' }}>
                    <span style={{ fontSize: 20 }}>📅</span>
                    <div style={{ fontSize: 11, marginTop: 4, color: 'var(--text-secondary)' }}>Book</div>
                  </div>
                  <div className="glass" style={{ flex: 1, padding: '14px 12px', textAlign: 'center' }}>
                    <span style={{ fontSize: 20 }}>⏭️</span>
                    <div style={{ fontSize: 11, marginTop: 4, color: 'var(--text-secondary)' }}>Skip</div>
                  </div>
                  <div className="glass" style={{ flex: 1, padding: '14px 12px', textAlign: 'center' }}>
                    <span style={{ fontSize: 20 }}>📊</span>
                    <div style={{ fontSize: 11, marginTop: 4, color: 'var(--text-secondary)' }}>History</div>
                  </div>
                </div>
              </div>
            </div>
