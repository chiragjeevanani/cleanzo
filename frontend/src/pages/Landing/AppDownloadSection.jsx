...
export default function AppDownloadSection() {
  ...
  const handleAppStoreClick = (e) => {
    e.preventDefault()
    showToast('Cleanzo iOS app is coming soon to the App Store!', 'info')
  }

  const handlePlayStoreClick = (e) => {
    e.preventDefault()
    showToast('Cleanzo Android app is coming soon to the Google Play Store!', 'info')
  }
        ...
        <div className="app-content reveal">
          <div className="app-text">
            ...
            <div className="app-badges">
              <a href="https://apps.apple.com/in/app/cleanzo/id6776524390" onClick={handleAppStoreClick} className="app-badge">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.company.cleanzo" onClick={handlePlayStoreClick} className="app-badge">
